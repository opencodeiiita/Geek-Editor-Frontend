...
const useUtilityClasses = ownerState => {
  ...
  const composedClasses = (0, _core.unstable_composeClasses)(slots, _switchClasses.getSwitchUtilityClass, classes);
...
const SwitchSwitchBase = (0, _styled.default)(_SwitchBase.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.switchBase, styles.input, ownerState.color !== 'default' && styles[`color${(0, _capitalize.default)(ownerState.color)}`]];
  }
})(({
  theme
}) => ({

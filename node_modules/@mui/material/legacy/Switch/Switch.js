...
var SwitchSwitchBase = styled(SwitchBase, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var ownerState = props.ownerState;
    return [styles.switchBase, styles.input, ownerState.color !== 'default' && styles["color".concat(capitalize(ownerState.color))]];
  }
})(function (_ref3) {
  var _ref4;
  ...
  }, ownerState.color !== 'default' && (_ref6 = {}, _defineProperty(_ref6, "&.".concat(switchClasses.checked), _defineProperty({

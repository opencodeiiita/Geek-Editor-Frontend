...
const Dashboard = () => {
    return (
        ...
        <div className="dashboard">
            ...
            <div className="main">
                <nav className="item1">
                    <div id="img" href="https://github.com/cmade" target="_blank"> <img className='img1' src="https://avatars2.githubusercontent.com/u/10188746?s=460&u=ebd07b3fe70fbaf057d8305f7e611d70be2448e1&v=4" alt="" /></div>
                    <div className='info'>
                        <span class="heading headingUsername">Username</span>
